...
class PlayScreen(private val game: YikersGame) : KtxScreen {
    ...
    private lateinit var draftOverlay: DraftOverlay
    ...
    private fun newRun() {
        ...
        draftOverlay = DraftOverlay(world, hudViewport, hudCamera, game)
    ...
    override fun render(delta: Float) {
        ...
        // An open draft (any human still choosing) takes the screen; the run is
        // frozen meanwhile. Otherwise the game-over panel, when dead.
        if (draftOverlay.active) {
            draftOverlay.render()
